...
<body bgcolor="white">
    ...
    <td class="style3">
        &nbsp;</td></tr>
    <tr>
     <td class="style3" style="background-color: #000000; color: #FFFFFF;">
                <asp:Menu ID="Menu1" runat="server" Font-Bold="True" Height="34px" 
    ...
    <td class="style3" align="center">
     <asp:Panel ID="Panel1" runat="server" Height="670px" Width="1331px">
    
    <table style="width: 747px; height: 438px;">
    <tr>
    <td class="style2" colspan="4" align="center"  
            style="font-weight: bold; font-size: large; color: #000000">LOGIN</td>
