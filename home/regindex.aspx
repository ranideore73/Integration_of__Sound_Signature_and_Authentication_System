...
<body bgcolor="white">
    ...
    <td class="style3">
        &nbsp;</td></tr>
    <tr>
     <td class="style3" style="background-color: #000000">
    ...
    <td class="style3" align="center">
     <asp:Panel ID="Panel1" runat="server" Height="732px" Width="1282px">
    
    <table style="width: 476px; height: 366px;">
    <tr>
    <td class="style2" colspan="4" align="center"  
            style="font-weight: bold; font-size: large; color: #000000">REGISTRATION </td>
