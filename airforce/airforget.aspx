<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="airforget.aspx.cs" Inherits="New.Web.Airforce.airforget" %>
...
<body bgcolor="white">
    ...
    <div>
        ...
        <td class="style1">
            &nbsp;</td></tr>
            <tr>
     <td class="style4" style="background-color: #000000; color: #FFFFFF;" bgcolor="#0099FF">
                <asp:Menu ID="Menu1" runat="server" Font-Bold="True" 
                    Font-Names="Verdana" ForeColor="#990000" Height="29px" 
                    Orientation="Horizontal" Width="448px" BackColor="#FFFBD6" DynamicHorizontalOffset="2" Font-Size="Medium" StaticSubMenuIndent="10px">
