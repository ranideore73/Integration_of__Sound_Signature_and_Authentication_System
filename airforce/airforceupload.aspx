...
<body bgcolor="silver">
    ...
    <table>
    <tr>
    <td style="background-color:#000000" class="auto-style1">
        <asp:Menu ID="Menu1" runat="server" Font-Bold="True" ForeColor="White" Height="40px" 
    ...
    <td class="auto-style2">
     <center>
        <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderColor="#8B630E" BorderStyle="Solid" Width="1308px" Height="663px"> 
           
        <table style="height: 517px; width: 830px;">
        <tr>
        <td  colspan="2">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td  colspan="2" align="center">
                    ...
                    <asp:GridView ID="gv_listoffiles" runat="server" AllowPaging="True" 
                        AutoGenerateColumns="False" CellPadding="4" ForeColor="Black" Height="259px" 
                        onpageindexchanging="gv_listoffiles_PageIndexChanging" 
                        onrowdeleting="gv_listoffiles_RowDeleting" PageSize="5" Width="428px" 
                        GridLines="None">
