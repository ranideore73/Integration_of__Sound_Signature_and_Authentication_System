...
<body bgcolor="white">
    ...
    <div>
        ...
        <td class="style1">
            &nbsp;</td></tr>
            <tr>
     <td class="style4" style="background-color: #000000; color: #FFFFFF;">
    ...
    <asp:ImageButton ID="ImageButton1" runat="server" onmousemove = "GetXY()" 
            ...
            ImageUrl="~/Image/defence1.jpg" onclick="ImageButton1_Click" />
    ...
    <asp:ImageButton  ID="ImageButton3" runat="server" onmousemove="GetXY()" 
            Width="120px" Height="104px" 
            ImageUrl="~/Image/defence2.jpg" onclick="ImageButton3_Click" />
