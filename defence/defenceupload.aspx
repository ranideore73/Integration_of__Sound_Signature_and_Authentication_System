...
<body bgcolor="white">
    ...
    <td class="auto-style1">
        &nbsp;</td></tr>
    <tr>
    <td style="background-color:#000000" class="auto-style2">
    ...
    <td class="auto-style1" style="background-color: #FFFFFF">
     <center>
        <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderColor="#8B630E" BorderStyle="Solid" Width="1341px" Height="680px"> 
           
        <table style="height: 493px; width: 557px;">
        <tr>
        <td  colspan="2">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td  colspan="2" align="center">
                    ...
                    <asp:GridView ID="gv_listoffiles" runat="server" AllowPaging="True" 
                        AutoGenerateColumns="False" CellPadding="4" Height="257px" 
            ...
            <center style="height: 57px; width: 1100px">
