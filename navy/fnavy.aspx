<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fnavy.aspx.cs" Inherits="New.Web.Navy.fnavy" %>
...
<body bgcolor="white">
    ...
    <asp:ImageButton ID="ImageButton1" runat="server" onmousemove = "GetXY()" 
            ...
            ImageUrl="http://localhost:1332/New.Web/Image/navy2.jpg" onclick="ImageButton1_Click" />
            
    <asp:ImageButton  ID="ImageButton2" runat="server" onmousemove="GetXY()" Height="104px"  
            ImageUrl="http://localhost:1332/New.Web/Image/navy3.jpg" onclick="ImageButton2_Click" Width="120px" />
    <asp:ImageButton  ID="ImageButton3" runat="server" onmousemove="GetXY()" 
            Width="120px" Height="104px" 
            ImageUrl="http://localhost:1332/New.Web/Image/navy4.jpg" onclick="ImageButton3_Click" />
    <asp:ImageButton  ID="ImageButton4" runat="server" onmousemove="GetXY()" 
            Width="120px" Height="104px" 
            ImageUrl="http://localhost:1332/New.Web/Image/navy5.jpg" onclick="ImageButton4_Click" />
